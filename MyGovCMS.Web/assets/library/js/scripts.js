...
----------------------------------------------------------------------------- */
  ...
  //                  $('head').append( '<link id="skin-temp" rel="stylesheet" type="text/css" href="/assets/library/css/skin/' + $(this).data( 'skin' ) + '.css">' );
		//		}
		//		else {
		//			$( '#skin-temp' ).attr( 'href', '/assets/library/css/skin/' + $(this).data( 'skin' ) + '.css' );
		//		}
		//	});
