            ...
            link: function link(scope, element, attrs) {
                ...
                function _upload(file) {
                    ...
                    reader.onload = function (e) {
                        ...
                        var chkBytejpg = new Uint8Array([255, 216, 255, 224]);
                        var chkBytebmp = new Uint8Array([66, 77]);
                        var chkBytegif = new Uint8Array([71, 73, 70, 56]);
                        var chkBytepng = new Uint8Array([137, 80, 78, 71]);
                        var chkBytepdf = new Uint8Array([37, 80, 68, 70]);
                        var chkBytedocx = new Uint8Array([80, 75, 3, 4]);
                        var chkBytesheet = new Uint8Array([80, 75, 3, 4]);
                        var chkBytexls = new Uint8Array([208, 207, 17, 224]);
                        var chkBytedoc = new Uint8Array([208, 207, 17, 224]);
                        var length = bytes.byteLength;
                        var isvalid = false;
                        if (file.type == "image/jpeg" || file.type == "image/jpg") {
                            if (length >= 4) {
                                if (bytes[0] == chkBytejpg[0] && bytes[1] == chkBytejpg[1] && bytes[2] == chkBytejpg[2] && (bytes[3] == chkBytejpg[3] || bytes[3] == 225)) {
                                    isvalid = true;
                                }
                            }
                        }
                            ...
                            if (length >= 4) {
                                if (bytes[0] == chkBytepng[0] && bytes[1] == chkBytepng[1] && bytes[2] == chkBytepng[2] && bytes[3] == chkBytepng[3]) {
                                    isvalid = true;
                                }
                            }
                        }
                            ...
                            if (length >= 4) {
                                if (bytes[0] == chkBytepdf[0] && bytes[1] == chkBytepdf[1] && bytes[2] == chkBytepdf[2] && bytes[3] == chkBytepdf[3]) {
                                    isvalid = true;
                                }
                            }
                        }
                            ...
                            if (length >= 4) {
                                if (bytes[0] == chkBytedocx[0] && bytes[1] == chkBytedocx[1] && bytes[2] == chkBytedocx[2] && bytes[3] == chkBytedocx[3]) {
                                    isvalid = true;
                                }
                            }
                        }
                            ...
                            if (length >= 4) {
                                if (bytes[0] == chkBytesheet[0] && bytes[1] == chkBytesheet[1] && bytes[2] == chkBytesheet[2] && bytes[3] == chkBytesheet[3]) {
                                    isvalid = true;
                                }
                            }
                        }
                            ...
                            if (length >= 4) {
                                if (bytes[0] == chkBytexls[0] && bytes[1] == chkBytexls[1] && bytes[2] == chkBytexls[2] && bytes[3] == chkBytexls[3]) {
                                    isvalid = true;
                                }
                            }
                        }
                            ...
                            if (length >= 4) {
                                if (bytes[0] == chkBytedoc[0] && bytes[1] == chkBytedoc[1] && bytes[2] == chkBytedoc[2] && bytes[3] == chkBytedoc[3]) {
                                    isvalid = true;
                                }
                            }
                        }
                        ...
                        if (isvalid) {
                            ...
                            file.serverErrorMessage = 'Invalid File';
                        }
                    };
